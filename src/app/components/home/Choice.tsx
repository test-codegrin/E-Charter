...
const Choice: FC = () => {
  return (
    <section className="w-full mt-[80px] px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 md:gap-10 lg:gap-12 xl:gap-16">
        {/* Image Section */}
