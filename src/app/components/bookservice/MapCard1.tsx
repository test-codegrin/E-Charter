...
const MapCard1 = () => {
  return (
    <div className="relative w-full max-h-[877px] mt-[30px] lg:mt-[0px] h-full ">
      ...
      {/* Route Info Card */}
      <div className="bg-white shadow-md rounded-lg px-3 sm:px-4 py-3 absolute bottom-10 sm:bottom-12 lg:bottom-6 left-1/2 -translate-x-1/2 w-[92%] sm:w-[95%] max-w-[1177px]">
        {/* Icons Row */}
