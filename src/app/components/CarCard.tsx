      ...
      <div className="lg:w-[100%] flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="space-y-2 text-sm sm:text-base">
            <div className="flex items-center gap-2">
              <img src="/images/Passanger.png" alt="Passengers" className="w-5 h-5" />
              <span className="text-[#616161]">Passengers {passengers}</span>
            </div>

            <div className="flex items-center gap-2">
              <img src="/images/Mileage.png" alt="Mileage" className="w-5 h-5" />
              <span className="text-[#616161]">{mileage}</span>
            </div>

            <div className="flex items-center gap-2">
              <img src="/images/Diesel.png" alt="Fuel type" className="w-5 h-5" />
              <span className="text-[#616161]">{fuel}</span>
            </div>

            <div className="flex items-start gap-2">
              <img src="/images/Map1.png" alt="Location" className="w-5 h-5 mt-1" />
              <p className="text-sm text-[#616161] leading-[1.7]">{location}</p>
            </div>
          </div>
        </div>
        ...
        <div className="md:w-60 flex flex-col gap-4 sm:gap-6">
          <div className="text-center border-b border-[#DBDBDB] pb-4">
            <p className="font-semibold text-[#616161] text-sm sm:text-base">Free Cancellation</p>
